      ...
      <div class="row justify-content-between ps-2 pe-2 ms-2 ms-2">
        <div class="col-auto">
          <a
            ...
            href=""
            @click="$router.push('/information/write')"
          >
            글쓰기
          </a>
        </div>
          ...
          <form id="form-search">
            ...
            <div class="row pe-2 me-2">
              ...
              <button
                ...
                @click="getInfoPosts(1, keyy, word)"
              >
                검색
              </button>
            </div>
          ...
          <div class="post-nav">
            <ul class="pagination justify-content-center">
              ...
              <li v-for="index in pageCount" :key="index" class="page-item" :data-pg="index">
                <a href="" class="page-link" @click="$router.push(`/information?pgno=${index}`)">{{
                  index
                }}</a>
              </li>
              <li class="page-item" data-pg="currentPage">
